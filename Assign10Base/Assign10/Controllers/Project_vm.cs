...
namespace Assign10.Controllers
{
    ...
    public class ProjectWithSharerInfo : ProjectBase
    {
        public ICollection<SharerBase> Sharers { get; set; }
    }

    public class ProjectWithAllInfo : ProjectBase
    {
        public ICollection<MediaBase> Medias { get; set; }
        public ICollection<SharerBase> Sharers { get; set; }
    }
    ...
    public class ProjectWithLink : ProjectWithAllInfo //ProjectWithMediaInfo before
    {
